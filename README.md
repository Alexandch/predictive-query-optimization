...
1. Десктопное приложение PyQt с анализом, историей, настройками и обучением.
2. Проверка переносимости на дополнительной предметной базе.
3. Упаковка приложения и подготовка материалов курсовой работы.
