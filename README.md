...
1. Добавление action-признаков `generic-v3` для несаргируемости, существующих
   индексов и размера целевой таблицы.
2. Подключение новой development-БД без раскрытия запечатанных контролей.
