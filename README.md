...
1. Добавление рекомендаций по агрегатам, соединениям и материализованным представлениям.
2. Сбор пользовательской обратной связи о принятых и отклонённых рекомендациях.
