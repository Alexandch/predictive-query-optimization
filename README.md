...
1. Накопление достаточного числа независимых замеров структурных рекомендаций.
2. Обучение модели ранжирования на принятых, отклонённых и измеренных советах.
