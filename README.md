...
1. Расширение обучающего набора селектора независимыми SQL-шаблонами.
2. Проверка устойчивости селектора на нескольких seed-разбиениях.
3. Интеграция принятой модели выбора стратегии в десктопное приложение.
