...
- три предметные области содержат 8 авиационных, 10 розничных и 10 логистических сущностей;
...
- на полностью исключённой из обучения схеме `logistics` XGBoost достигает
  `R² = 0,8636`, а DQN снижает mean regret с `0,2557` случайной стратегии до `0,1064`;
...
1. Расширение DQN отрицательными примерами без загрязнения запечатанных контролей.
