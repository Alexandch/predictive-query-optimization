...
`dist\installer\PredictiveQueryOptimization-Setup-0.5.0.exe`

SHA-256 сборки:
`499150285CD1FF67420F40A1D7E51E8C8496EB0D029E43EE41EE24BBE97D7419`.
...
Установщик 0.5.0 собран на Python 3.13.3. Для обычного запуска
