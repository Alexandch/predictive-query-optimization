...
Следующий эксперимент с балансировкой шаблонов и нормализацией шумных DQN-наград
описан в [chbenchmark-balanced-experiment.md](chbenchmark-balanced-experiment.md).
После первого сравнения кандидатов этот CH-набор считается development-control,
а не новым запечатанным финальным контролем.
